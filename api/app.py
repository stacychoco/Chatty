...
@app.route('/api/request_chat', methods=["POST"], endpoint='request_chat')
@jwt_required()
def request_chat():
...
@app.route('/api/users', methods=["GET"], endpoint='users')
@jwt_required()
def users():
...
@app.route('/api/get_message/<channel_id>', endpoint='user_messages')
@jwt_required()
